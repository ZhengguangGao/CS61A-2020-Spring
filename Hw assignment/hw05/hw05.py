    ...
    def vend(self):
        ...
        if self.stock == 0:
            ...
            if self.balance < self.price:
                ...
                return 'Here is your {} and ${} change.'.format(self.item,temp-self.price)
...
def remove_all(link , value):
    ...
    # if link.rest == Link.empty and link.first == value:
...
def deep_map(f, link):
    ...
    if link.rest == Link.empty:
        ...
        if isinstance(link.first, Link):
            ...
            temp = deep_map(f,link.first)

        else:

            temp = f(link.first)

        return Link(temp,deep_map(f,link.rest))
